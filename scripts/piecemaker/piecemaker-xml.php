...
echo '<Piecemaker>';
	echo '<Contents>';
		...
		$jw_slider_content = preg_replace('/\[slide/', '[slide_piecemaker', $post_custom['jw_slider'][0]);		
		$jw_slider_content = preg_replace('/\[\/slide/', '[/slide_piecemaker', $jw_slider_content);		
		echo do_shortcode($jw_slider_content);
		
	echo '</Contents>';
	echo '<Settings ImageWidth="960" ImageHeight="'.$height.'" LoaderColor="0x333333" InnerSideColor="0x222222" SideShadowAlpha="0.8" DropShadowAlpha="0.4" DropShadowDistance="25" DropShadowScale="0.95" DropShadowBlurX="40" DropShadowBlurY="4" MenuDistanceX="20" MenuDistanceY="50" MenuColor1="0x999999" MenuColor2="0x333333" MenuColor3="0xFFFFFF" ControlSize="100" ControlDistance="20" ControlColor1="0x222222" ControlColor2="0xFFFFFF" ControlAlpha="0.8" ControlAlphaOver="0.95" ControlsX="480" ControlsY="'.$controls_y.'&#xD;&#xA;" ControlsAlign="center" TooltipHeight="30" TooltipColor="0x222222" TooltipTextY="5" TooltipTextStyle="P-Italic" TooltipTextColor="0xFFFFFF" TooltipMarginLeft="5" TooltipMarginRight="7" TooltipTextSharpness="50" TooltipTextThickness="-100" InfoWidth="400" InfoBackground="0xFFFFFF" InfoBackgroundAlpha="0.95" InfoMargin="15" InfoSharpness="0" InfoThickness="0" Autoplay="10" FieldOfView="45"></Settings>';
	echo '<Transitions>';
